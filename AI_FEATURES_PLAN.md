...
| **Groq** | Permanent free, no card | **~1,000 req/day** per model (was 14,400) | **~6,000 TPM** on small Llama (the binding limit) | `openai/gpt-oss-120b`, `openai/gpt-oss-20b`, `llama-4-scout`, `qwen3-32b`, `whisper-large-v3` | Very fast (~320 tok/s on 70B) | Yes | **Short, high-frequency classification** + **Whisper STT** (voice attendance/feedback). Broadest healthy catalog → safest default |
