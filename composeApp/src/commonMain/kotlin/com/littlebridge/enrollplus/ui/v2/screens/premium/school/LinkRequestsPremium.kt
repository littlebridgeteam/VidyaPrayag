...
fun LinkRequestsPremium(
    ...
    Column(
        ...
        VBackHeader(title = "Link Requests", onBack = onBack)

        VStateHostPremium(
            loading = state.isLoading,
            error = state.error,
            isEmpty = state.requests.isEmpty() && !state.isLoading,
            emptyTitle = "No pending link requests",
            skeleton = {
                Column(
            ...
            Column(
                ...
                state.requests.forEach { req ->
                    VListTilePremium(
                        title = req.parentName ?: "Unknown",
                        subtitle = "Child: ${req.childName ?: "—"} - ${req.className ?: "—"}",
                        onClick = {},
