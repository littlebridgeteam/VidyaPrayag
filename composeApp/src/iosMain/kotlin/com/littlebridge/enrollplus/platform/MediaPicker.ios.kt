    ...
    return remember {
        object : MediaPicker {
            override fun launchImage() {
                onUnsupported("Image picker is not yet supported on iOS. Please use 'Paste Text' mode.")
            }

            override fun launchPdf() {
                onUnsupported("PDF picker is not yet supported on iOS. Please use 'Paste Text' mode.")
            }
        }
    }
}
